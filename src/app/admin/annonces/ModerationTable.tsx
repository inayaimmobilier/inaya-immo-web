...
export interface AnnonceRow {
  id: string; reference: number | null; titre: string; type_offre: string; categorie: string; statut: string
                  ...
                  <td className="px-3 py-3">
                    <Link href={`/admin/annonces/${p.id}`} className="flex items-center gap-3 group">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] font-semibold text-blue-600">{p.reference != null ? `N°${p.reference}` : `INA-${p.id.replace(/-/g, "").slice(0, 6).toUpperCase()}`}</p>
                        {p.reported > 0
