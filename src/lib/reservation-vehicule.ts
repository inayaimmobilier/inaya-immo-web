...
// ============================================================================
// DEMANDE DE RÉSERVATION — logique partagée site web / application mobile.
//
// Les deux passent par ici. Écrire la règle deux fois aurait garanti qu'un
// jour le site refuse un chevauchement que l'application accepte, ou que le
// tarif dégressif ne s'applique que d'un côté.
//
...
export type ResReservation = { ok: true; reference: number | null } | { ok: false; error: string }
...
export async function creerReservationVehicule(
  d: DemandeReservationInput,
  /** Client connecté, quand il y en a un. */
  clientId: string | null = null,
): Promise<ResReservation> {
