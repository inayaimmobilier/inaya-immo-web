...
export const HELP = [
  ...
  "",
  "Écrivez-moi <b>en langage naturel</b>, je suis Inaya — par exemple :",
  "• « montre les annonces en attente »",
  "• « combien de visites aujourd'hui ? »",
  "• « qui a publié l'annonce 5043 ? » (contact du publieur)",
  "• « les demandes reçues cette semaine »",
  "• « que cherchent les clients en ce moment ? »",
  "• « passe l'annonce 5043 à 20000 »",
  "",
  "Je garde le fil de la conversation : après une recherche, « et à Air France ? »",
  "suffit. <b>/nouvelle</b> repart de zéro.",
  "",
  "<b>Commandes</b>",
